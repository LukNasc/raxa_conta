...
class _HomePageState extends State<HomePage> {
  ...
  void _calcular() {
    ...
    setState(() {
      _valorPessoa =
          "O valor por pessoa é R\$ ${valorDividido.toStringAsPrecision(2)}";
    });
  }
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                //Widget de input de número de pessoas
                TextFormField(
                  ...
                  validator: (value) {
                    if (value.isEmpty) {
                      return 'Insira o valor da quantidade de pessoas';
                    }
                  },
                ),
                //Widget de input de valor da conta
                TextFormField(
                  keyboardType: TextInputType.number,
                ...
                //Texto que exibe o valor da conta por pessoa
                Text(_valorPessoa,
                    textAlign: TextAlign.center,
                    style: TextStyle(color: Colors.blue, fontSize: 18))
              ],
